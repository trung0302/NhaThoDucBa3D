        ...
        <div style={{marginTop: 90}} className="w-full">
            ...
            <Container style={{marginBottom: 20}}>
                ...
                <Grid container spacing={2} >
                    ...
                    <Grid item xs={6}>
                        <h2 style={{fontSize: "2rem", fontWeight: "bold", margin:"0 0 10px 0", textAlign: "center"}}>Lịch sử nhà thờ</h2>
                        <p style={{fontSize: "1.5rem", textAlign: "justify", textJustify: "inter-word"}}>
                            {showMore ? text : `${text.slice(0, text.length / 2)}...`}
                        </p>
                        <div className="flex" style={{textAlign: "justify", justifyContent: "center", marginTop: 10 }}>
                            <Button variant="contained" style={{fontSize: "1.1rem"}} onClick={toggleShowMore}>
                ...
                <Grid container spacing={2}>
                    <Grid item xs={6} container className="flex" direction={"column"} alignItems="center">
                    <h2 style={{width:300 ,fontSize: "2rem", fontWeight: "bold", margin:"0 0 10px 0", textAlign: "center"}}>Tòa thánh đường bên trong nhà thờ</h2>
                        <p style={{fontSize: "1.5rem", textAlign: "justify", textJustify: "inter-word"}}>
                            {showMore2 ? text2 : `${text2.slice(0, text2.length / 2)}...`}
                        </p>
                        <div className="flex" style={{textAlign: "justify", justifyContent: "center", marginTop: 10}}>
                            <Button variant="contained" style={{fontSize: "1.1rem"}} onClick={toggleShowMore2}>
                    ...
                    <Grid item xs={6} container className="flex" direction={"column"} alignItems={"center"}>
                    <h2 style={{width:300 ,fontSize: "2rem", fontWeight: "bold", margin:"0 0 10px 0", textAlign: "center"}}>Khu vực công viên phía ngoài</h2>
                        <p style={{fontSize: "1.5rem", textAlign: "justify", textJustify: "inter-word"}}>
                            {showMore3 ? text3 : `${text3.slice(0, text3.length / 2)}...`}
                        </p>
                        <div className="flex" style={{textAlign: "justify", justifyContent: "center", marginTop: 10}}>
                            <Button variant="contained" style={{fontSize: "1.1rem"}} onClick={toggleShowMore3}>
